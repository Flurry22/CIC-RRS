            ...
            <div class="box p-3 rounded-2 text-white " style= "background-color: #818589;">
                <div class="form-group">
                    ...
                    <select id="research-type-select" class="form-control narrow-select" onchange="updateFormAction()">
                        <option value="{{ route('research.create', ['type' => 'program']) }}" >Program</option>
                        <option value="{{ route('research.create', ['type' => 'project']) }}"selected>Project</option>
...
<br>
    ...
    <!-- Research Title -->
    <div class="form-group">
        <label for="title" style="color: white;"><strong>Project Title:</strong></label>
    ...
    <!-- Research Leader -->
    <div class="form-group">
        <label for="leader_id" style="color: white;"><strong>Project  Leader:</strong></label>
    ...
    @enderror
                    ...
                    <!-- Researcher Members -->
                    <div class="form-group mt-3">
    <label for="researchers"style="color: white;"><strong>Select Members:</strong></label>
    ...
    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group" >
                            <label class="mt-2"style="color: white;"><input class="form-check-input" type="checkbox" id="select-all-sdgs"> Select All</label><br>
    ...
    <div class="checkbox-group">
        <label class="mt-2" style="color: white;">
            <input class="form-check-input" type="checkbox" id="select-all-dost6ps"> Select All
        </label><br>
