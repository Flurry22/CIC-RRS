            ...
            <div class="box p-3 rounded-2 text-white " style= "background-color: #818589;">
                <div class="form-group">
                    ...
                    <select id="research-type-select" class="form-control narrow-select" onchange="updateFormAction()">
                        ...
                        <option value="{{ route('research.create', ['type' => 'study']) }}" selected>Study</option>
                    </select>
                </div>
...
<br>
    ...
    <!-- Research Title -->
    <div class="form-group">
        <label for="title" style="color: white;"><strong>Study Title:</strong></label>
    ...
    <!-- Research Leader -->
    <div class="form-group">
        <label for="leader_id" style="color: white;"><strong>Study Leader:</strong></label>
