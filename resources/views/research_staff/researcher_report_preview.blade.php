...
<body>
<div class="buttons">
        <a href="{{ route('researchers.index') }}" class="btn btn-secondary">Back to Researchers</a>
        <a href="{{ route('researcher.report.pdf', $researcher->id) }}" class="btn" style="background-color: #922220; color:white;">
            Generate PDF
        </a>
    </div>
<div class="container">
